...
export class EditPostService implements EditPostInterface {
  ...
  public async execute(payload: EditPostDto): Promise<PostInterfaceDto> {
  ...
  private async defineNewImage(payload: EditPostDto, post: Post): Promise<Optional<Nullable<PostImage>>> {
