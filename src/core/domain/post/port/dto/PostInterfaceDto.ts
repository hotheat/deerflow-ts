...
export class PostInterfaceDto {
  ...
  public static newFromPost(post: Post): PostInterfaceDto {
    const dto: PostInterfaceDto =  plainToClass(PostInterfaceDto, post);
  ...
  public static newListFromPosts(posts: Post[]): PostInterfaceDto[] {
